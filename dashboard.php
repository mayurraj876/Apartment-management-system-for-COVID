...
//Last Sevendays visitors
 $query2=mysqli_query($con,"select ID from tblvisitor where date(EnterDate)>=(DATE(NOW()) - INTERVAL 10 DAY);");
                                    ...
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                ...
                                                <span>Last 10 Days Visitors</span>
                                            </div>
                                        </div>
...
<?php					   
                   ...
                   //Total Visitors visitors
 $query4=mysqli_query($con,"select ID from tblqua");
$count_total_quar=mysqli_num_rows($query4);
 ?>                       
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                                <h2><?php echo $count_total_quar?></h2>
                                                <span>Total Quarantine </span>
                                            </div>
                                        </div>
