...
$pass=$_POST['pass'];
 $query=mysqli_query($con,"insert into tblowner(OwnerName,MobileNumber,Address,Email,Password,Apartment) value('$ownname','$mobnumber','$add','$eid','$pass','$apart')");

    if ($query) {
    $msg="Owner Detail has been added.";
  }
  else
    {
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="ownname" name="ownname" placeholder="Owner Name" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                             ...
                                             <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="eid" name="eid" placeholder="Email ID" class="form-control" required="true">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="pass" name="pass" placeholder="Password" class="form-control" required="true">
