...
$apart=$_POST['apartment'];
 ...
 $query=mysqli_query($con,"insert into tblqua(Quarantinename,MobileNumber,Apartment) value('$quaname','$mobnumber','$apart')");

    if ($query) {
    $msg="Quarantine Detail has been added.";
  }
  else
    {
...
<head>
    ...
    <!-- Title Page-->
    <title>AVM Quarantine Forms</title>
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Add</strong> New quarantine
                                    </div>
    ...
    echo $msg;
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="text-input" class=" form-control-label">Quarantine Name</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="quaname" name="quaname" placeholder="Quarantine Name" class="form-control" required="true">
